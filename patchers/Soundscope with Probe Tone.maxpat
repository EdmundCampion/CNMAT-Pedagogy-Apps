...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 969.0, 540.384633421897888, 55.769230961799622, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 669.0, 606.0, 53.5, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1015.0, 377.615375339984894, 65.0, 20.0 ],
					"text" : "Frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1187.0, 375.615375339984894, 36.0, 20.0 ],
					"text" : "Base"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1164.0, 261.615375339984894, 83.0, 22.0 ],
					"text" : "loadmess 440"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1135.0, 375.615375339984894, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 946.0, 375.615375339984894, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.0, 451.615375339984894, 208.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 918.0, 506.5, 52.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 632.0, 583.0, 34.0, 33.0 ],
					"text" : "midi \nnote"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 811.0, 332.0, 34.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 637.0, 525.0, 23.0, 20.0 ],
					"text" : "Hz"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 969.0, 512.0, 55.769230961799622, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 668.0, 583.0, 53.5, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 604.0, 110.0, 122.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 482.0, 2.0, 105.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 369.0, 94.0, 99.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 665.0, 548.0, 70.0, 33.0 ],
					"text" : "key arrow \nnudge +/- 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.115384519100189, 331.0, 55.769230961799622, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 665.0, 524.0, 60.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 670.0, 7.0, 60.0, 506.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 372.0, 30.0, 89.0, 37.0 ],
					"text" : "Signal from anywhere in Max\nwith send~ signalX"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 538.0, 76.0, 96.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 528.0, 76.0, 118.5, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 528.0, 51.0, 118.5, 22.0 ],
					"textcolor" : [ 0.149, 0.149, 0.149, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 60.0, 65.0, 33.0, 22.0 ],
									"text" : "t s 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.0, 135.0, 32.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 18.0, 95.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 482.0, 32.0, 43.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 369.0, 70.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 524.0, 30.0, 131.25, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 477.0, 30.0, 178.5, 69.0 ],
					"proportion" : 0.5,
					"rounded" : 16
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 665.0, 3.0, 70.0, 515.0 ],
					"proportion" : 0.39
				}
