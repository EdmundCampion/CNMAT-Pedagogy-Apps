...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.0, 127.0, 77.0, 22.0 ],
					"text" : "r globalreset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 952.0, 125.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.0, 165.0, 72.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 715.0, 210.0, 32.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 420.0, 44.0, 19.0 ],
					"text" : "round 1."
				}
...
,
					"patching_rect" : [ 495.0, 370.0, 65.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 405.0, 146.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 865.0, 25.0, 223.0, 22.0 ],
					"restore" : 					{
						"fundamental" : [ 110.000000123187974 ],
						"interval" : [ 12 ],
						"key_selection" : [ "i" ],
						"keyboard" : [ 45 ],
						"num_selection" : [ "1" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 125.0, 89.0, 22.0 ],
					"text" : "sel 13 102 103"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 379.0, 79.0, 31.0, 19.0 ],
					"text" : "spell"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 25.0, 32.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 360.0, 110.0, 38.0, 19.0 ],
					"text" : "sel 49"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 365.0, 45.0, 47.0, 22.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 260.0, 308.0, 47.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.0, 462.0, 100.0, 22.0 ],
					"text" : "send~ tuneaudio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 755.0, 135.0, 32.5, 22.0 ],
					"text" : "45"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 520.0, 295.0, 27.0, 19.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 755.0, 30.0, 48.0, 19.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 495.0, 108.0, 40.0, 19.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 495.0, 130.0, 41.0, 19.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 195.0, 70.0, 31.0, 19.0 ],
					"text" : "spell"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 40.0, 38.0, 22.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 260.0, 286.0, 38.0, 22.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 150.0, 110.0, 65.0, 19.0 ],
					"text" : "sel 113"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 150.0, 70.0, 40.0, 19.0 ],
					"text" : "key"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 332.0, 154.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 332.0, 190.0, 124.0, 22.0 ],
									"text" : "set mywave2_ped.aiff"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 130.0, 301.0, 32.0, 19.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 67.0, 112.0, 46.0, 19.0 ],
									"text" : "t b f b"
								}
...
, 							{
								"box" : 								{
									"addpoints" : [ 0.0, 0.0, 0, 148.936170212765944, 0.96, 0, 260.638297872340445, 0.52, 0, 760.638297872340445, 0.226666666666667, 0, 882.978723404255334, 0.0, 0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 130.0, 363.0, 35.0, 19.0 ],
									"text" : "*~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 155.0, 339.0, 34.0, 19.0 ],
									"text" : "cycle~"
								}
...
,
					"patching_rect" : [ 103.0, 387.0, 66.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 225.0, 215.0, 20.0, 19.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"bgfillcolor_color2" : [ 1.0, 0.890196, 0.090196, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 175.0, 57.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 358.0, 67.0, 57.0, 29.0 ],
					"text" : "reset",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 952.0, 251.0, 84.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 187.0, 258.0, 84.0, 29.0 ],
					"text" : "n/a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "float" ],
					"patching_rect" : [ 795.0, 235.0, 63.0, 19.0 ],
					"text" : "unpack s s f"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 795.0, 212.0, 70.0, 19.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 795.0, 180.0, 162.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 185.0, 225.0, 162.0, 24.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "interval"
				}
...
,
					"patching_rect" : [ 495.0, 335.0, 94.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 495.0, 75.0, 49.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 185.0, 165.0, 49.0, 29.0 ],
					"triscale" : 0.9,
					"varname" : "step"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 659.0, 425.0, 127.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 350.0, 335.0, 77.0, 29.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 310.0, 31.0, 19.0 ],
					"text" : "ftom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 335.0, 62.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 225.0, 31.0, 19.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 265.0, 70.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 260.0, 335.0, 70.0, 26.0 ],
					"triscale" : 0.9,
					"varname" : "fundamental"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 400.0, 38.0, 19.0 ],
					"text" : "ftom 0."
				}
